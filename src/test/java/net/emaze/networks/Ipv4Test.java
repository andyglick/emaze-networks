...
public class Ipv4Test {
    ...
    public void canExtractFirstOctet() {        
        Assert.assertEquals(127, Ipv4.parse("127.0.0.1").octets()[0]);
    }
    
    @Test
    public void canExtractLastOctet() {        
        Assert.assertEquals(1, Ipv4.parse("127.0.0.1").octets()[3]);
    }
    @Test
    public void octetsAreUnsigned() {        
        Assert.assertEquals(255, Ipv4.parse("255.0.0.0").octets()[0]);
    }
    ...
    public void firstIsLessThanLast() {
        Assert.assertEquals(Order.LT.order(), Ipv4.FIRST_IP.compareTo(Ipv4.LAST_IP));
    }
    ...
    public void nextOfLastIsItself() {
        Assert.assertEquals(Ipv4.LAST_IP, Ipv4.LAST_IP.next());
    }
    ...
    public void previousOfFirstIsItself() {
        Assert.assertEquals(Ipv4.FIRST_IP, Ipv4.FIRST_IP.previous());
    }
    ...
    public void toStringRendersCorrectlyWhenHighestBitOn() {
        Assert.assertEquals("255.255.255.255", Ipv4.LAST_IP.toString());
    }

    @Test
    public void toStringRendersCorrectlyWhenHighestBitOff() {
        Assert.assertEquals("0.0.0.0", Ipv4.FIRST_IP.toString());
    }
}
