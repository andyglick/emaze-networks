...
public class Ipv6NetworkTypeTest {
    ...
    public void canSerializeAndDeserializeANetwork() {
        ...
        container.setNetwork(Ipv6Network.fromCidrNotation("::/64"));
        ...
        hibernateOperations.execute(new HibernateCallback<Ipv6NetworkContainer>() {
            ...
            public Ipv6NetworkContainer doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                Assert.assertEquals(Ipv6Network.fromCidrNotation("::/64"), got.getNetwork());
                return got;
            }
        });
    }
    ...
    public static class Ipv6NetworkContainer {
        ...
        @GeneratedValue
        private Integer id;
        @Type(type = "net.emaze.networks.hibernate.Ipv6NetworkType")
