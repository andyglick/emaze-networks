...
public class Ipv6RangeToNetworks implements BiFunction<Ipv6, Ipv6, List<Ipv6Network>> {

    private final Ipv6SortNetworksByFirstThenLastIp sorter = new Ipv6SortNetworksByFirstThenLastIp();

    @Override
    public List<Ipv6Network> apply(Ipv6 firstIp, Ipv6 lastIp) {
        ...
        final Ipv6Network spanningCidr = new Ipv6RangeToSpanningNetwork().apply(firstIp, lastIp);
    ...
    private LinkedList<Ipv6Network> pruneSpanningCidrHead(Ipv6Network head, Ipv6 firstIp) {
        ...
        final List<Ipv6Network> remainder = sorter.apply(new Ipv6SubtractIpFromNetwork().apply(head, previousIp));
    ...
    private LinkedList<Ipv6Network> pruneSpanningCidrTail(Ipv6Network tail, Ipv6 lastIp) {
        ...
        final LinkedList<Ipv6Network> result = new LinkedList<>();
        final List<Ipv6Network> remainder = sorter.apply(new Ipv6SubtractIpFromNetwork().apply(tail, nextIp));
        for (Ipv6Network cidr : remainder) {
            result.add(cidr);
