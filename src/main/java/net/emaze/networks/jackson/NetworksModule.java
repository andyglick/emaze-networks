...
public class NetworksModule extends SimpleModule {
    ...
    public NetworksModule() {
        ...
        this.addSerializer(Ip.class, new Ipv4ToString());
        this.addDeserializer(Ip.class, new Ipv4FromString());
        this.addSerializer(Mask.class, new NetmaskToString());
        this.addDeserializer(Mask.class, new NetmaskFromString());
