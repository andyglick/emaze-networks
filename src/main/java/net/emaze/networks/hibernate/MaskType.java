...
public class MaskType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        return parseMaskV4OrV6((String) cached);
    }
    ...
    private Object parseMaskV4OrV6(final String stored) throws NumberFormatException {
        if (stored.contains(".")) {
            return Mask.netV4(stored);
        }
        return Mask.netV6(Integer.parseInt(stored));
    }
}
