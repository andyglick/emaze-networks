...
public interface IpPolicy extends SequencingPolicy<Ip> {
    ...
    String toCanonicalMaskString(int maskPopulation);
    ...
    public static class V6 implements IpPolicy {
        ...
        @Override
        public String toCanonicalMaskString(int maskPopulation) {
            return String.valueOf(maskPopulation);
        }
    ...
    public static class V4 implements IpPolicy {
        ...
        @Override
        public String toCanonicalMaskString(int maskPopulation) {
            return toCanonicalString(FixedSizeNatural.biggest(IPV4_BITS).shiftLeft(IPV4_BITS - maskPopulation));
        }
